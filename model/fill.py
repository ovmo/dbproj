...
def fillDB():
    ...
    sauce2 = save_new_toppings(name="Sauce", price=1.00, vegi=True)

    db.session.add(sauce)
    db.session.add(sauce2)
    ...
    #creating the Pizzas
    pizza_magarita = save_new_pizza("Margherita", ["Sauce", "Sauce", "Cheese"])
    pizza_caprese = save_new_pizza("Caprese", ["Sauce", "Sauce", "Mozzarella", "Cherry Tomatoes"])
    pizza_buratina = save_new_pizza("Buratina", ["Sauce", "Sauce", "Buratta", "Cherry Tomatoes", "Basil"])
    pizza_fungi = save_new_pizza("Fungi", ["Sauce", "Sauce", "Cheese", "Mushroom", "Olives"])
    pizza_parma = save_new_pizza("Parma", ["Sauce", "Sauce", "Cheese", "Parma", "Arugula"])
    pizza_prosciutto = save_new_pizza("Prosciutto", ["Sauce", "Sauce", "Cheese", "Prosciutto"])
    pizza_pepperoni = save_new_pizza("Pepperoni", ["Sauce", "Sauce", "Cheese", "Pepperoni"])
    pizza_diavola = save_new_pizza("Diavola", ["Sauce", "Sauce", "Cheese", "Chicken", "Cherry Tomatoes", "Basil"])
    pizza_salami = save_new_pizza("Salami", ["Sauce", "Sauce", "Cheese", "Salami"])
    pizza_romana = save_new_pizza("Romana", ["Sauce", "Sauce", "Cheese", "Olives", "Anchovy", "Capers"])
    pizza_napoli = save_new_pizza("Napoli", ["Sauce", "Sauce", "Cheese", "Oregano", "Anchovy"])
    pizza_marinara = save_new_pizza("Marinara", ["Sauce", "Sauce", "Garlic", "Basil"])
    pizza_crudo = save_new_pizza("Crudo", ["Sauce", "Sauce", "Cheese", "Parma"])
    pizza_tricolore = save_new_pizza("Tricolore", ["Sauce", "Sauce", "Bresaola", "Parmesan"])
